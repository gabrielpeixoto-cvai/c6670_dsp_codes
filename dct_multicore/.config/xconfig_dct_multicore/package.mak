...
override PKGDIR = xconfig_dct_multicore
...
package/%.xdc.inc package/%_xconfig_dct_multicore.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_dct_multicore" (because $@ is older than $(firstword $?))" ...
...
.PHONY: release,xconfig_dct_multicore
xconfig_dct_multicore.tar: package/package.bld.xml
xconfig_dct_multicore.tar: package/build.cfg
xconfig_dct_multicore.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_dct_multicore.tar.dep
endif
package/rel/xconfig_dct_multicore/xconfig_dct_multicore/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_dct_multicore.tar: package/rel/xconfig_dct_multicore.xdc.inc package/rel/xconfig_dct_multicore/xconfig_dct_multicore/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_dct_multicore.xdc.inc,package/rel/xconfig_dct_multicore.tar.dep)


release release,xconfig_dct_multicore: all xconfig_dct_multicore.tar
clean:: .clean
	-$(RM) xconfig_dct_multicore.tar
	-$(RM) package/rel/xconfig_dct_multicore.xdc.inc
	-$(RM) package/rel/xconfig_dct_multicore.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_dct_multicore.pjt
