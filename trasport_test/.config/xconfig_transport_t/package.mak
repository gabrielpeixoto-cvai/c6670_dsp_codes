...
override PKGDIR = xconfig_transport_t
...
package/%.xdc.inc package/%_xconfig_transport_t.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_transport_t" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: transport_t.pe66

-include package/cfg/transport_t_pe66.mak
-include package/cfg/transport_t_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/transport_t_pe66.dep
endif
transport_t.pe66: package/cfg/transport_t_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
transport_t.pe66 package/cfg/transport_t_pe66.c: .libraries,e66
endif

package/cfg/transport_t_pe66.c package/cfg/transport_t_pe66.h package/cfg/transport_t_pe66.xdl: override _PROG_NAME := transport_t.xe66
package/cfg/transport_t_pe66.c: package/cfg/transport_t_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/transport_t_pe66.cfg
	-$(RM) package/cfg/transport_t_pe66.dep
	-$(RM) package/cfg/transport_t_pe66.c
	-$(RM) package/cfg/transport_t_pe66.xdc.inc

clean,e66::
	-$(RM) transport_t.pe66
.executables,e66 .executables: transport_t.xe66

transport_t.xe66: |transport_t.pe66

-include package/cfg/transport_t.xe66.mak
transport_t.xe66: package/cfg/transport_t_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/transport_t_pe66.oe66   package/cfg/transport_t_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
transport_t.xe66: export C_DIR=
transport_t.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

transport_t.test test,e66 test: transport_t.xe66.test

transport_t.xe66.test:: transport_t.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 transport_t.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.transport_t.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,transport_t.xe66,0,*
...
clean,e66::
	-$(RM) transport_t.xe66
clean:: 
	-$(RM) package/cfg/transport_t_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
transport_t_pe66.oe66,copy : package/cfg/transport_t_pe66.oe66
transport_t_pe66.se66,copy : package/cfg/transport_t_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_transport_t
xconfig_transport_t.tar: package/package.bld.xml
xconfig_transport_t.tar: package/build.cfg
xconfig_transport_t.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_transport_t.tar.dep
endif
package/rel/xconfig_transport_t/xconfig_transport_t/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_transport_t.tar: package/rel/xconfig_transport_t.xdc.inc package/rel/xconfig_transport_t/xconfig_transport_t/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_transport_t.xdc.inc,package/rel/xconfig_transport_t.tar.dep)


release release,xconfig_transport_t: all xconfig_transport_t.tar
clean:: .clean
	-$(RM) xconfig_transport_t.tar
	-$(RM) package/rel/xconfig_transport_t.xdc.inc
	-$(RM) package/rel/xconfig_transport_t.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_transport_t.pjt
