...
override PKGDIR = xconfig_transport
...
package/%.xdc.inc package/%_xconfig_transport.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_transport" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: transport.pe66

-include package/cfg/transport_pe66.mak
-include package/cfg/transport_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/transport_pe66.dep
endif
transport.pe66: package/cfg/transport_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
transport.pe66 package/cfg/transport_pe66.c: .libraries,e66
endif

package/cfg/transport_pe66.c package/cfg/transport_pe66.h package/cfg/transport_pe66.xdl: override _PROG_NAME := transport.xe66
package/cfg/transport_pe66.c: package/cfg/transport_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/transport_pe66.cfg
	-$(RM) package/cfg/transport_pe66.dep
	-$(RM) package/cfg/transport_pe66.c
	-$(RM) package/cfg/transport_pe66.xdc.inc

clean,e66::
	-$(RM) transport.pe66
.executables,e66 .executables: transport.xe66

transport.xe66: |transport.pe66

-include package/cfg/transport.xe66.mak
transport.xe66: package/cfg/transport_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/transport_pe66.oe66   package/cfg/transport_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
transport.xe66: export C_DIR=
transport.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

transport.test test,e66 test: transport.xe66.test

transport.xe66.test:: transport.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 transport.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.transport.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,transport.xe66,0,*
...
clean,e66::
	-$(RM) transport.xe66
clean:: 
	-$(RM) package/cfg/transport_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
transport_pe66.oe66,copy : package/cfg/transport_pe66.oe66
transport_pe66.se66,copy : package/cfg/transport_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_transport
xconfig_transport.tar: package/package.bld.xml
xconfig_transport.tar: package/build.cfg
xconfig_transport.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_transport.tar.dep
endif
package/rel/xconfig_transport/xconfig_transport/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_transport.tar: package/rel/xconfig_transport.xdc.inc package/rel/xconfig_transport/xconfig_transport/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_transport.xdc.inc,package/rel/xconfig_transport.tar.dep)


release release,xconfig_transport: all xconfig_transport.tar
clean:: .clean
	-$(RM) xconfig_transport.tar
	-$(RM) package/rel/xconfig_transport.xdc.inc
	-$(RM) package/rel/xconfig_transport.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_transport.pjt
