...
override PKGDIR = xconfig_core_multitask
...
package/%.xdc.inc package/%_xconfig_core_multitask.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_core_multitask" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e66 .dlls: core_multitask.pe66

-include package/cfg/core_multitask_pe66.mak
-include package/cfg/core_multitask_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/core_multitask_pe66.dep
endif
core_multitask.pe66: package/cfg/core_multitask_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
core_multitask.pe66 package/cfg/core_multitask_pe66.c: .libraries,e66
endif

package/cfg/core_multitask_pe66.c package/cfg/core_multitask_pe66.h package/cfg/core_multitask_pe66.xdl: override _PROG_NAME := core_multitask.xe66
package/cfg/core_multitask_pe66.c: package/cfg/core_multitask_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/core_multitask_pe66.cfg
	-$(RM) package/cfg/core_multitask_pe66.dep
	-$(RM) package/cfg/core_multitask_pe66.c
	-$(RM) package/cfg/core_multitask_pe66.xdc.inc

clean,e66::
	-$(RM) core_multitask.pe66
.executables,e66 .executables: core_multitask.xe66

core_multitask.xe66: |core_multitask.pe66

-include package/cfg/core_multitask.xe66.mak
core_multitask.xe66: package/cfg/core_multitask_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/core_multitask_pe66.oe66   package/cfg/core_multitask_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
core_multitask.xe66: export C_DIR=
core_multitask.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

core_multitask.test test,e66 test: core_multitask.xe66.test

core_multitask.xe66.test:: core_multitask.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 core_multitask.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.core_multitask.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,core_multitask.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) core_multitask.xe66
clean:: 
	-$(RM) package/cfg/core_multitask_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
core_multitask_pe66.oe66,copy : package/cfg/core_multitask_pe66.oe66
core_multitask_pe66.se66,copy : package/cfg/core_multitask_pe66.se66

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_core_multitask
xconfig_core_multitask.tar: package/package.bld.xml
xconfig_core_multitask.tar: package/build.cfg
xconfig_core_multitask.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_core_multitask.tar.dep
endif
package/rel/xconfig_core_multitask/xconfig_core_multitask/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_core_multitask.tar: package/rel/xconfig_core_multitask.xdc.inc package/rel/xconfig_core_multitask/xconfig_core_multitask/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_core_multitask.xdc.inc,package/rel/xconfig_core_multitask.tar.dep)


release release,xconfig_core_multitask: all xconfig_core_multitask.tar
clean:: .clean
	-$(RM) xconfig_core_multitask.tar
	-$(RM) package/rel/xconfig_core_multitask.xdc.inc
	-$(RM) package/rel/xconfig_core_multitask.tar.dep
...
include custom.mak
clean:: 
	-$(RM) package/xconfig_core_multitask.pjt
