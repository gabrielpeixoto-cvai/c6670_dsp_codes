...
.dlls,e66 .dlls: infrastructure_multicoremode.pe66

-include package/cfg/infrastructure_multicoremode_pe66.mak
-include package/cfg/infrastructure_multicoremode_pe66.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/infrastructure_multicoremode_pe66.dep
endif
infrastructure_multicoremode.pe66: package/cfg/infrastructure_multicoremode_pe66.xdl
	@


ifeq (,$(wildcard .libraries,e66))
infrastructure_multicoremode.pe66 package/cfg/infrastructure_multicoremode_pe66.c: .libraries,e66
endif

package/cfg/infrastructure_multicoremode_pe66.c package/cfg/infrastructure_multicoremode_pe66.h package/cfg/infrastructure_multicoremode_pe66.xdl: override _PROG_NAME := infrastructure_multicoremode.xe66
package/cfg/infrastructure_multicoremode_pe66.c: package/cfg/infrastructure_multicoremode_pe66.cfg

clean:: clean,e66
	-$(RM) package/cfg/infrastructure_multicoremode_pe66.cfg
	-$(RM) package/cfg/infrastructure_multicoremode_pe66.dep
	-$(RM) package/cfg/infrastructure_multicoremode_pe66.c
	-$(RM) package/cfg/infrastructure_multicoremode_pe66.xdc.inc

clean,e66::
	-$(RM) infrastructure_multicoremode.pe66
.executables,e66 .executables: infrastructure_multicoremode.xe66

infrastructure_multicoremode.xe66: |infrastructure_multicoremode.pe66

-include package/cfg/infrastructure_multicoremode.xe66.mak
infrastructure_multicoremode.xe66: package/cfg/infrastructure_multicoremode_pe66.oe66 
	$(RM) $@
	@$(MSG) lnke66 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C66.rootDir)/bin/lnk6x -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@)  -q -o $@ package/cfg/infrastructure_multicoremode_pe66.oe66   package/cfg/infrastructure_multicoremode_pe66.xdl --abi=eabi -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C66.rootDir)/lib/libc.a
	
infrastructure_multicoremode.xe66: export C_DIR=
infrastructure_multicoremode.xe66: PATH:=$(ti.targets.elf.C66.rootDir)/bin/:$(PATH)

infrastructure_multicoremode.test test,e66 test: infrastructure_multicoremode.xe66.test

infrastructure_multicoremode.xe66.test:: infrastructure_multicoremode.xe66
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 infrastructure_multicoremode.xe66.test
else
	@$(MSG) running $<  ...
	$(call EXEC.infrastructure_multicoremode.xe66, ) 
endif

clean,e66::
	-$(RM) .tmp,infrastructure_multicoremode.xe66,0,*


clean:: clean,e66

clean,e66::
	-$(RM) infrastructure_multicoremode.xe66
clean:: 
	-$(RM) package/cfg/infrastructure_multicoremode_pe66.pjt
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
infrastructure_multicoremode_pe66.oe66,copy : package/cfg/infrastructure_multicoremode_pe66.oe66
infrastructure_multicoremode_pe66.se66,copy : package/cfg/infrastructure_multicoremode_pe66.se66
